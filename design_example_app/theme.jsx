// Tokens live here so Tweaks can flip them via CSS vars.
// Palette: warm-neutral dark with electric-green accent.
...
const makeCssVars = ({ accentHue = 145 } = {}) => ({
...
Object.assign(window, { ACCENT_PRESETS, DENSITY_PRESETS, makeCssVars });
